            ...
            ${project.deployUrl ? `
              <a href="${project.deployUrl}" target="_blank" rel="noopener noreferrer" class="project-link-btn project-link-deploy">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M11 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V9m-4-4h4m-4-4v4m4-4l-8 8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                Ver Demo
              </a>
            ` : ''}
